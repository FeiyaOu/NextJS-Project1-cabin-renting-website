...
export async function updateGuest(id, updatedFields) {
  ...
  if (error) {
    // Log extra context so the caller can see why the update failed
    console.error('updateGuest failed', { id, updatedFields, error });
    // Throw a more informative error (preserve supabase message when available)
